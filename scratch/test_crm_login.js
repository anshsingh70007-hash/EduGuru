...
let content = fs.readFileSync(path.join(__dirname, '../CRM/index.html'), 'utf8');
content = content.replace(/<base href="\/CRM\/">/i, '');
const testPath = path.join(__dirname, '../CRM/test_login.html');
...
(async () => {
    ...
    console.log('Failed URLs count:', failedUrls.length);
